  ...
  const SignUpScreen = () => (
    <div className="h-full flex flex-col bg-[#FDFBF7] px-6 pt-2 overflow-y-auto">
      ...
      <div className="space-y-3 mb-4">
        {userType === 'business' && (
          <div>
            <label className="text-xs font-medium text-[#0A1626] mb-1 block">Business name</label>
            <div className="relative">
              <LayoutDashboard className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9FB3C8]" />
              <input 
                type="text" 
        ...
        <div>
          <label className="text-xs font-medium text-[#0A1626] mb-1 block">Email</label>
          <div className="relative">
            <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9FB3C8]" />
            <input 
              type="email" 
        ...
        <div>
          <label className="text-xs font-medium text-[#0A1626] mb-1 block">Password</label>
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9FB3C8]" />
            <input 
              type={showPassword ? 'text' : 'password'} 
      ...
      <button onClick={handleSignup} className="w-full py-2.5 bg-[#00BFA5] text-white rounded-lg font-semibold text-sm flex items-center justify-center gap-1.5">
