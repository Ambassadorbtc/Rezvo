...
const YourDetails = ({ data, onCreate, onBack }) => {
  ...
  return (
    <div className="max-w-xl mx-auto px-5 pt-6">
      ...
      {/* Form */}
      <h2 className="text-base font-semibold text-[#111111] mb-3">Your details</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5 pb-28">
        <div>
          ...
          <input
            ...
            className="w-full px-3.5 py-2.5 rounded-lg border border-gray-200 bg-white text-gray-900 text-[15px] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#111111]/20 focus:border-[#111111] transition-all"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2.5 rounded-lg border border-gray-200 bg-white text-gray-900 text-[15px] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#111111]/20 focus:border-[#111111] transition-all min-h-[80px] resize-none"
