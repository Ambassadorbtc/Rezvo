        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
          <div className="mb-8">
            ...
            <p className="text-muted text-base">
              Log in to manage your bookings and discover new venues.
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 border-2 border-border rounded accent-forest cursor-pointer"
                />
                <span className="text-sm text-muted font-medium">Remember me</span>
              </label>

              <Link
                to="/forgot-password"
                className="text-sm text-forest font-semibold hover:text-sage transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted">
              ...
              <Link to="/signup" className="text-forest font-bold hover:text-sage transition-colors">
                Get Started Free
              </Link>
            </p>
          </div>
