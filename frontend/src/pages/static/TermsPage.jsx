...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-white">
      <SEO title="Terms of Service" description="Read the Reeve Now Terms of Service governing use of our platform." path="/terms" />
      <Navbar />
      <section className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-sm max-w-none font-body text-muted space-y-6">
            <Sec title="1. Acceptance of Terms">By using Reeve Now ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, please do not use the Platform.</Sec>
            <Sec title="2. Description of Service">Reeve Now provides a booking and management platform connecting consumers with independent restaurants, salons, barbers, spas, and other service businesses across the United Kingdom.</Sec>
            ...
            <Sec title="4. Bookings">Bookings made through Reeve Now create a direct arrangement between you and the business. Reeve Now facilitates but is not a party to these arrangements. Cancellation policies are set by individual businesses.</Sec>
            ...
            <Sec title="7. Limitation of Liability">Reeve Now is provided "as is". We are not liable for any losses arising from bookings, business conduct, or service quality. Our total liability is limited to fees paid to us in the preceding 12 months.</Sec>
