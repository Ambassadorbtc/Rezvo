...
const TOOLS = [
  ...
  { slug: 'booking-link-maker', name: 'Instant Booking Link', desc: 'Create a quick one-time booking link to share with clients.', icon: Link2, color: '#00BFA5', bg: '#E8F5F3', ready: false },
  { slug: 'domain-seo-checker', name: 'Domain SEO Checker', desc: 'Check domain age, SSL, speed score and basic SEO health.', icon: Globe, color: '#8B5CF6', bg: '#EDE9FE', ready: false },
  { slug: 'opening-hours-gap', name: 'Opening Hours Gap Finder', desc: 'Find scheduling gaps and overlaps in your business hours.', icon: Clock, color: '#F59E0B', bg: '#FEF3E2', ready: false },
  { slug: 'review-reply', name: 'Review Reply Generator', desc: 'Generate professional replies for customer reviews.', icon: Star, color: '#3B82F6', bg: '#DBEAFE', ready: false },
  { slug: 'social-post-ideas', name: 'Social Post Ideas', desc: 'Get 10 social media post ideas for your business niche.', icon: Lightbulb, color: '#EF4444', bg: '#FEE2E2', ready: false },
  { slug: 'client-intake', name: 'Client Intake Questions', desc: 'Generate intake questionnaires for your industry.', icon: MessageSquare, color: '#00BFA5', bg: '#E8F5F3', ready: false },
  { slug: 'xml-sitemap-generator', name: 'XML Sitemap Generator', desc: 'Generate an XML sitemap by crawling your website.', icon: Map, color: '#8B5CF6', bg: '#EDE9FE', ready: false },
  { slug: 'sitemap-extractor', name: 'Sitemap URL Extractor', desc: 'Extract all URLs from any sitemap.xml file.', icon: Database, color: '#F59E0B', bg: '#FEF3E2', ready: false },
  { slug: 'sitemap-validator', name: 'Sitemap Validator', desc: 'Validate your sitemap XML structure and URLs.', icon: CheckSquare, color: '#3B82F6', bg: '#DBEAFE', ready: false },
  { slug: 'sitemap-finder', name: 'Sitemap Finder', desc: 'Find sitemaps and robots.txt for any domain.', icon: Search, color: '#EF4444', bg: '#FEE2E2', ready: false },
  { slug: 'url-extractor', name: 'Website URL Extractor', desc: 'Extract all visible links from any webpage.', icon: Code, color: '#00BFA5', bg: '#E8F5F3', ready: false },
  { slug: 'robots-txt-checker', name: 'Robots.txt Checker', desc: 'Fetch and analyze any site\'s robots.txt file.', icon: Bot, color: '#8B5CF6', bg: '#EDE9FE', ready: false },
  { slug: 'page-speed', name: 'Page Speed Tester', desc: 'Test page load speed with Google PageSpeed Insights.', icon: Zap, color: '#F59E0B', bg: '#FEF3E2', ready: false },
  { slug: 'meta-tag-checker', name: 'Meta Tag Checker', desc: 'Check title, description, OG tags and canonical URLs.', icon: FileCode, color: '#3B82F6', bg: '#DBEAFE', ready: false },
  { slug: 'broken-link-checker', name: 'Broken Link Checker', desc: 'Find 404 errors and broken links on any page.', icon: AlertTriangle, color: '#EF4444', bg: '#FEE2E2', ready: false },
  { slug: 'markdown-converter', name: 'Anything to Markdown', desc: 'Convert PDF, Word, HTML, JSON and more to Markdown.', icon: FileDown, color: '#00BFA5', bg: '#E8F5F3', ready: false },
];
