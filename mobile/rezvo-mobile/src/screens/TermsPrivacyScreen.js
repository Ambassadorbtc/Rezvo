      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <TouchableOpacity 
            ...
            onPress={() => openLink('https://booking-upgrade-9.preview.emergentagent.com/terms')}
          >
          ...
          <TouchableOpacity 
            style={styles.linkItem}
            onPress={() => openLink('https://booking-upgrade-9.preview.emergentagent.com/privacy')}
          >
            <View style={styles.linkLeft}>
          ...
          <TouchableOpacity 
            style={styles.linkItem}
            onPress={() => openLink('https://booking-upgrade-9.preview.emergentagent.com/cookies')}
          >
            <View style={styles.linkLeft}>
