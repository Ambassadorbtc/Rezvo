...
const styles = StyleSheet.create({
  ...
  bookingBlock: { position: 'absolute', left: 4, right: 4, borderRadius: 8, borderLeftWidth: 3, padding: 6, overflow: 'hidden' },
  bookingTime: { fontSize: 11, fontWeight: '600' },
  bookingClient: { fontSize: 12, fontWeight: '600', color: '#0A1626', marginTop: 2 },
  bookingService: { fontSize: 11, color: '#627D98', marginTop: 1 },
  // Week view
  weekViewContainer: { flex: 1, paddingHorizontal: 16 },
  weekGrid: { flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#FFF', borderRadius: 16, overflow: 'hidden' },
  weekDayColumn: { width: '14.28%', minHeight: 140, borderRightWidth: 1, borderBottomWidth: 1, borderColor: '#E2E8F0', padding: 8 },
  weekDayToday: { backgroundColor: '#E8F5F3' },
  weekDayHeader: { alignItems: 'center', marginBottom: 8 },
  weekDayName: { fontSize: 11, fontWeight: '600', color: '#9FB3C8', textTransform: 'uppercase' },
  weekDayNameToday: { color: TEAL },
  weekDayDate: { fontSize: 18, fontWeight: '700', color: '#0A1626', marginTop: 2 },
  weekDayDateToday: { color: TEAL },
  weekDayBookings: { flex: 1 },
  weekBookingItem: { borderLeftWidth: 3, borderRadius: 4, padding: 6, marginBottom: 4 },
  weekBookingTime: { fontSize: 10, fontWeight: '600' },
  weekBookingClient: { fontSize: 11, fontWeight: '500', color: '#0A1626' },
  moreBookings: { fontSize: 10, color: TEAL, fontWeight: '600', marginTop: 4 },
  noBookings: { fontSize: 10, color: '#9FB3C8', fontStyle: 'italic' },
  // Month view
