...
const styles = StyleSheet.create({
  ...
  memberName: { fontSize: 11, color: '#0A1626', fontWeight: '600', textAlign: 'center', marginTop: 4 },
  ...
  moveConfirmModal: { backgroundColor: '#FFF', borderRadius: 20, width: '90%', maxWidth: 340, padding: 24 },
  moveConfirmHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 20 },
  moveConfirmTitle: { fontSize: 20, fontWeight: '700', color: '#0A1626' },
  moveConfirmContent: { marginBottom: 20 },
  moveConfirmService: { fontSize: 18, fontWeight: '700', color: '#0A1626', marginBottom: 4 },
  moveConfirmClient: { fontSize: 14, color: '#627D98', marginBottom: 16 },
  moveTimeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12 },
  moveTimeBox: { flex: 1, backgroundColor: '#F5F0E8', borderRadius: 12, padding: 12, alignItems: 'center' },
  moveTimeBoxNew: { backgroundColor: '#E8F5F3', borderWidth: 2, borderColor: TEAL },
  moveTimeLabel: { fontSize: 12, color: '#627D98', marginBottom: 4 },
  moveTimeValue: { fontSize: 20, fontWeight: '700', color: '#0A1626' },
  moveConfirmButtons: { flexDirection: 'row', gap: 12 },
  moveCancelBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#F5F0E8', paddingVertical: 14, borderRadius: 50 },
  moveCancelText: { fontSize: 15, fontWeight: '600', color: '#627D98' },
  moveConfirmBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: TEAL, paddingVertical: 14, borderRadius: 50 },
  moveConfirmText: { fontSize: 15, fontWeight: '600', color: '#FFF' },
  // Move Mode Bar
  moveModeBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: TEAL, paddingVertical: 16, paddingHorizontal: 24, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  moveModeText: { fontSize: 14, fontWeight: '600', color: '#FFF' },
  moveModeCancelText: { fontSize: 14, fontWeight: '700', color: '#FFF', textDecorationLine: 'underline' },
});
