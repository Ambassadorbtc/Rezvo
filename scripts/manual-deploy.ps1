# Manual Deployment Commands for Rezvo
...
Write-Host "`n`nThese commands are also saved to manual-commands.txt" -ForegroundColor Green
$commands | Out-File -FilePath "manual-commands.txt" -Encoding UTF8

Write-Host "`nTo use:`n1. SSH in: ssh root@178.128.33.73`n2. Copy/paste commands above`n" -ForegroundColor Yellow
